      ...
      <main className="main-content">
        ...
        <header className="header">
          <div className="header-left">
            ...
            <h2 className="page-title-header">Rent Payments</h2>
          </div>
        ...
        <div className="dashboard-content">
          ...
          <div className="page-header">
            <div className="page-title">
              <h1>Rent Payments</h1>
              <p>Manage your rent and token payments</p>
            </div>
          ...
          <div className="quick-pay-section">
            ...
            <div className="payment-methods">
              <div className="payment-method">eSewa</div>
              <div className="payment-method">Khalti</div>
              <div className="payment-method">Bank</div>
              <div className="payment-method">IPS</div>
            </div>
          </div>
