      ...
      <aside className={`sidebar ${sidebarOpen ? "open" : ""}`}>
        ...
        <nav className="nav-menu">
          ...
          <div className="nav-section">
            ...
            <Link to="/blocked-users" className="nav-item active">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="dashboard-content">
          <div className="page-header">
            <div className="page-title">
              <h1>Blocked Users</h1>
              <p>Manage blocked and suspended user accounts</p>
            </div>
          </div>
                  ...
                  <tr>
                    <td>
                      <div className="user-row">
                        ...
                        <span>Fake Seeker</span>
                      </div>
                    </td>
                    <td>fake.user@email.com</td>
                    <td>Blocked</td>
                    <td>Scam Activity</td>
                    <td>Mar 10, 2026</td>
                    <td>
                      <div className="action-buttons">
                        ...
                        <button className="action-btn edit">Appeal</button>
                        <button className="action-btn block">Unblock</button>
                      </div>
                    </td>
                  </tr>
                </tbody>
